...
<head>
	...
	<title>Home | Sakinah E-Shop</title>
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +031 5926020</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> sakinahsupermarketn@email.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="social-icons pull-right">
							<ul class="nav navbar-nav">
								<li><a href="https://www.facebook.com/pages/category/Shopping---Retail/Sakinah-Swalayan-Keputih-786294581481105/"><i class="fa fa-facebook"></i></a></li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="<?php echo base_url();?>"><img src="<?php echo base_url()?>assets/front/images/home/sakinah.png" alt="" /></a>
						</div>
					...
					<div class="col-sm-7">
							...
							<div class="video-gallery text-center">
								<a href="#">
									<div class="iframe-img">
										<img src="<?php echo base_url()?>assets/front/images/home/product7.png" alt="" />
									</div>
						...
						<div class="col-sm-3">
							<div class="video-gallery text-center">
								<a href="#">
									<div class="iframe-img">
										<img src="<?php echo base_url()?>assets/front/images/home/product8.png" alt="" />
									</div>
									<div class="overlay-icon">
										<i class="fa fa-play-circle-o"></i>
									</div>
